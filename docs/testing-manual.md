...
- [ ] **CHAT-SLOTS-V3-06c** (W16) QAM closed when the answer finishes: the reply-ready toast still appears (regression check on the completion watch) — not attempted 2026-09-18; still owed. Evidence `docs/test-evidence/plan61-CHAT-SLOTS-V3-06c.json`.
...
- [ ] **CHAT-SLOTS-V3-15d** (label updates live) Ask the first question in a fresh chat while staying on it: the row's title should
  ...
  (on the maintainer's own PC, not in this repo); still owed for the maintainer to watch.
