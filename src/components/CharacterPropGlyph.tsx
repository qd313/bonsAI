...
import type { PropName } from "../data/characterPropGlyphAppearance";
import { CHARACTER_PROPS, inkForDisc } from "../data/characterPropGlyphAppearance";
 ...
 *
 * The prop/tint lookup table and the ink-contrast math live in
 * ../data/characterPropGlyphAppearance.ts, split out 2026-09-21 (plan 63 lane Z) to keep this
 * file, which is nothing but the SVG art itself, under the file-size ratchet without touching
 * any path data.
 */
