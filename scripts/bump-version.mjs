...
console.log(`  3. Commit to main — GitHub Actions auto-builds zip + Release when plugin.json version is new`);
console.log(`     (optional: git tag v${next} && git push origin v${next})`);
