...
const PROTECT_PROGRESSION_TITLES = [
  ...
  "thousand-year door",
  "new vegas",
  // 58 phase 1 lane G (2026-09-18): GTA III - The Definitive Edition has a Steam AppID, but
  // this title-name fallback is added to match its siblings above (San Andreas, IV, V), which
