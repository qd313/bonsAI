...
**Risk: LOW** — with one gate. **Blocked on [D2](../audit/maintainer-decisions-archive.md#d2--a-whole-group-of-backend-functions-is-unused-safe-to-delete).**
...
> [D2](../audit/maintainer-decisions-archive.md#maintainer-decisions-locked--2026-08-02). `apply_tdp` has no
...
behavior-preserving**. **Blocked on [D3](../audit/maintainer-decisions-archive.md#d3--the-riskiest-refactor-has-no-safety-net-how-do-you-want-to-handle-it).** `npm test` would pass with every component deleted.
