...
lives in strategy_entity_extraction.py, and the spoiler-policy wording (spoiler consent
check, low-spoiler-risk title logic, and the actual policy paragraphs) now lives in
strategy_spoiler_policy.py; both are re-exported here.
"""
