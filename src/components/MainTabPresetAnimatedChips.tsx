...
import {
  PresetChipButton,
  PresetChipLeadingBadges,
  PresetChipText,
} from "../features/preset-carousel/presetChipButton";
...
// Re-exported so MainTabPresetAnimatedChips.test.tsx's existing import keeps working unchanged;
// the real definition now lives in presetRowFocusNav.tsx alongside PresetRowFocusRoot.
