# Maintainer decisions archive (settled, before D90)

Every settled maintainer decision numbered below D90, moved word for word out of [maintainer-decisions-locked.md](maintainer-decisions-locked.md) on 2026-09-24 by plan 65, so that file stays a reasonable size to read. Nothing here is reworded and no decision number changed; a decision still finds its number here or there.
