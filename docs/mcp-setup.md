...
|------|---------|----------------------|---------------------|--------|
| 2026-09-25 | **The exit-game tool stopped on Steam's own Home screen twice during the plan 68 Deck pass, after a plugin reload had left Home sitting in front of the game that was still running underneath.** Both times the driver exited the game by hand instead, reading focus after every press. Ask: have the exit tool look past Steam's Home screen for a game still running underneath, not just at what is on screen. | this file | *pending* | Open, needs filing |
