...
[maintainer-decisions-locked.md](../audit/maintainer-decisions-locked.md) — **D23–D27 all locked
...
Full reasoning for each in [maintainer-decisions-locked.md](../audit/maintainer-decisions-locked.md).
